...
#ifndef _FURUNO_DRS_RECEIVE_H_
#define _FURUNO_DRS_RECEIVE_H_
...
class FurunoDRSReceive : public RadarReceive {
 public:
  FurunoDRSReceive(radar_pi *pi, RadarInfo *ri, NetworkAddress reportAddr, NetworkAddress dataAddr) : RadarReceive(pi, ri) {
 ...
 private:
  ...
  bool IsValidFurunoAddress(struct ifaddrs *nif);
